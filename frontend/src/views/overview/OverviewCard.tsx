 ...
 * `leaderRosterEntryIds: string[] | 'unpublished'`), never a quality or
 * runtime type, so the boundary the two panels keep is not defeated one
 * level up (see `views/boundary.test.ts`).
 */
