// Mirrors `read_model.quality_view`'s JSON shape exactly (every field this
// module cannot compute is `Maybe<T>`), the same discipline `api/types.ts`
// holds for `RunsView`. Deliberately does not import `views/runtime/types.ts`
// or `views/energy/types.ts` -- see `views/boundary.test.ts`.
